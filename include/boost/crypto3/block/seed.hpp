...
#include <boost/crypto3/block/detail/seed/seed_policy.hpp>
            ...
            protected:
                ...
                inline void schedule_key(const key_type &key) {
                    ...
                    for (size_t i = 0; i != 16; i += 2) {
                        ...
                        WK[0] = (WK[0] >> 8) | (::boost::crypto3::detail::extract_uint_t<CHAR_BIT>(WK[1], 3) << 24);
                        WK[1] = (WK[1] >> 8) | T;
                        ...
                        T = ::boost::crypto3::detail::extract_uint_t<CHAR_BIT>(WK[3], 0);
                        WK[3] = (WK[3] << 8) | ::boost::crypto3::detail::extract_uint_t<CHAR_BIT>(WK[2], 0);
                        WK[2] = (WK[2] << 8) | T;
                    }
                }
            };

        ...
        namespace block {
            namespace detail {
                ...
                struct streebog_policy : public ::boost::crypto3::detail::basic_functions<64> {
                    constexpr static const std::size_t word_bits = ::boost::crypto3::detail::basic_functions<64>::word_bits;
                    constexpr static const std::size_t word_bytes = word_bits / CHAR_BIT;
                    typedef typename ::boost::crypto3::detail::basic_functions<64>::word_type word_type;

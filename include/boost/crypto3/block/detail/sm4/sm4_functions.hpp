    ...
    namespace crypto3 {
        namespace block {
            namespace detail {
                ...
                struct sm4_functions : public ::boost::crypto3::detail::basic_functions<WordBits> {
                    ...
                    inline static word_type t_slow(word_type b, const constants_type &constants) {
                        const word_type t = ::boost::crypto3::detail::make_uint_t<WordBits>(
                            constants[::boost::crypto3::detail::extract_uint_t<CHAR_BIT>(b, 0)],
                            constants[::boost::crypto3::detail::extract_uint_t<CHAR_BIT>(b, 1)],
                            constants[::boost::crypto3::detail::extract_uint_t<CHAR_BIT>(b, 2)],
                            constants[::boost::crypto3::detail::extract_uint_t<CHAR_BIT>(b, 3)]);
                    ...
                    inline static word_type t(word_type b, const transposed_constants_type &constants) {
                        return constants[::boost::crypto3::detail::extract_uint_t<CHAR_BIT>(b, 0)] ^

...
#include <boost/crypto3/block/detail/des/des_policy.hpp>
            ...
            namespace detail {
                ...
                public:
                    ...
                    inline static word_type spbox(word_type T0, word_type T1) {
                        return policy_type::sbox1[::boost::crypto3::detail::extract_uint_t<CHAR_BIT>(T0, 0)] ^
                               policy_type::sbox2[::boost::crypto3::detail::extract_uint_t<CHAR_BIT>(T1, 0)] ^
                               policy_type::sbox3[::boost::crypto3::detail::extract_uint_t<CHAR_BIT>(T0, 1)] ^
                               policy_type::sbox4[::boost::crypto3::detail::extract_uint_t<CHAR_BIT>(T1, 1)] ^
                               policy_type::sbox5[::boost::crypto3::detail::extract_uint_t<CHAR_BIT>(T0, 2)] ^
                               policy_type::sbox6[::boost::crypto3::detail::extract_uint_t<CHAR_BIT>(T1, 2)] ^
                               policy_type::sbox7[::boost::crypto3::detail::extract_uint_t<CHAR_BIT>(T0, 3)] ^
                               policy_type::sbox8[::boost::crypto3::detail::extract_uint_t<CHAR_BIT>(T1, 3)];
                    }

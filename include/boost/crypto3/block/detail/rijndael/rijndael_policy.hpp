...
#include <boost/crypto3/block/detail/rijndael/rijndael_functions.hpp>
        ...
        namespace block {
            namespace detail {
                ...
                struct rijndael_policy : public basic_rijndael_policy<KeyBits, BlockBits> {
                    ...
                    typedef typename ::boost::crypto3::detail::basic_functions<word_bits>::word_type key_schedule_word_type;

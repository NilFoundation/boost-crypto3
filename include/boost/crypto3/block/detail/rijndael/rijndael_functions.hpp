...
#include <boost/crypto3/block/algorithm/copy_n_if.hpp>
    ...
    namespace crypto3 {
        namespace block {
            namespace detail {
                ...
                struct rijndael_functions : public ::boost::crypto3::detail::basic_functions<WordBits> {
                    constexpr static const std::size_t byte_bits =
                        ::boost::crypto3::detail::basic_functions<WordBits>::byte_bits;
                    typedef typename ::boost::crypto3::detail::basic_functions<WordBits>::byte_type byte_type;

                    constexpr static const std::size_t word_bits =
                        ::boost::crypto3::detail::basic_functions<WordBits>::word_bits;
                    ...
                    inline static typename ::boost::crypto3::detail::basic_functions<WordBits>::word_type
                        rotate_left(typename ::boost::crypto3::detail::basic_functions<WordBits>::word_type x) {

...
#include <boost/crypto3/hash/hash_value.hpp>
...
namespace boost {
    namespace crypto3 {
         ...
         * not all such hashes functions meet their goals, in particular @ref boost::crypto3::hashes::md4 "MD4" and @ref
         * boost::crypto3::hashes::md5 "MD5" are trivially broken. However they are still included due to their wide
        ...
        typename std::enable_if<::boost::crypto3::detail::is_iterator<OutputIterator>::value, OutputIterator>::type

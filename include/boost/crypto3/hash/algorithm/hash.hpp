...
namespace boost {
    namespace crypto3 {
        namespace hash {
             ...
             * not all such hash functions meet their goals, in particular @ref boost::crypto3::hash::md4 "MD4" and @ref
             * boost::crypto3::hash::md5 "MD5" are trivially broken. However they are still included due to their wide

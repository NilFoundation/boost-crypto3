        ...
        namespace hash {
            ...
            protected:
                ...
                void process_block() {
                    ...
                    block_type block;
                    ::boost::crypto3::detail::pack<endian_type, value_bits, word_bits>(value_array, block);
                ...
                typename boost::enable_if_c<length_bits && sizeof(Dummy)>::type append_length(length_type length) {
                    ...
                    ::boost::crypto3::detail::pack<endian_type, length_bits, word_bits>(length_array, length_words_array);
            ...
            public:
                ...
                haifa_stream_processor &update_n(InputIterator p, size_t n) {
                    ...
                    for (; n >= block_values; n -= block_values, p += block_values) {
                        // Convert the input into words
                        block_type block;
                        ::boost::crypto3::detail::pack_n<endian_type, value_bits, word_bits>(
                ...
                digest_type end_message() {
                    ...
                    ::boost::crypto3::detail::pack<endian, 1, ValueBits>(padding_bits, padding_values);
                    update_one(padding_values[0]);
#else
                    value_type pad = 0;
                    ::boost::crypto3::detail::imploder_step<endian_type, 1, value_bits, 0>::step(1, pad);
                    update_one(pad);
#endif

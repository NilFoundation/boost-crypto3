...
#include <boost/crypto3/block/streebog.hpp>
    ...
    namespace crypto3 {
        namespace hash {
            namespace detail {
                ...
                struct streebog_policy : public ::boost::crypto3::detail::basic_functions<64> {
                ...
                template<>
                struct streebog_policy<512> : public ::boost::crypto3::detail::basic_functions<64> {

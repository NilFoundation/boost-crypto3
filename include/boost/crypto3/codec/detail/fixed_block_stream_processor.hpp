            ...
            private:
                ...
                void update_one(value_type value) {
                    ...
                    if (i == input_block_bits - value_bits) {
                        ...
                        ::boost::crypto3::detail::pack_to<endian_type, value_bits, input_value_bits>(cache.begin(), cache.end(), block.begin());
...
#pragma clang loop unroll(full)
                    for (; n >= block_values; n -= block_values, first += block_values) {
                        ...
                        ::boost::crypto3::detail::pack_to<endian_type, value_bits, input_value_bits>(first, first + block_values, block.begin());
            ...
            public:
                ...
                virtual ~fixed_block_stream_processor() {
                    if (!cache.empty()) {
                        ...
                        ::boost::crypto3::detail::pack_to<endian_type, value_bits, input_value_bits>(cache.begin(), cache.begin() + cache.size(), block.begin());
